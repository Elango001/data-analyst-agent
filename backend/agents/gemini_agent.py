...
class ChatGemini(BaseAgent):
    ...
    def split_agent_output(self, response: Any) -> Tuple[str, List[Dict[str, Any]], Optional[str]]:
        """Split model output into reasoning text, tool calls, and optional code.

        Supports outputs that contain:
        - plain natural language reasoning
        - Gemini function/tool call parts
